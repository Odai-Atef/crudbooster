...
@section('content')
    ...
    <div style="width:750px;margin:0 auto ">
        ...
        @if(CRUDBooster::getCurrentMethod() != 'getProfile')
            <p>
                <a href='{{CRUDBooster::mainpath()}}'>{{cbLang("form_back_to_list",['module'=>CRUDBooster::getCurrentModule()->name])}}</a>
            </p>
    @endif
        ...
        <div class="box box-primary">
            ...
            <form method='post'
                ...
                <div class="box-body">
                    ...
                    <div class='form-group'>
                        ...
                        <select name='theme_color' class='form-control' required>
                            ...
                            ?>
                            <option
                                <?=(@$row->theme_color == $skin) ? "selected" : ""?> value='<?=$skin?>'><?=ucwords(str_replace('-', ' ', $skin))?></option>
                            <?php endforeach;?>
                        </select>
                    ...
                    <div id='privileges_configuration' class='form-group'>
                        ...
                        <table class='table table-striped table-hover table-bordered'>
                            ...
                            <tr class='active'>
                                ...
                                <th>{{cbLang('privileges_module_list_recommend')}}</th>
                                <th>{{cbLang('privileges_module_list_assessment')}}</th>
                                <th>{{cbLang('privileges_module_list_accept')}}</th>
                            </tr>
                            <tr class='info'>
                                <th>&nbsp;</th>
                                <th>&nbsp;</th>
                            ...
                            @foreach($moduls as $modul)
                                ...
                                <tr>
                                    ...
                                    @if ($modul->name=="Projects")

                                        <td class='danger' align="center"><input type='checkbox' class='is_recommended'
                                                                                 name='privileges[<?=$modul->id?>][is_recommended]'
                                                                                 <?=@$roles->is_recommended ? "checked" : ""?> value='1'/>
                                        </td>
                                        <td class='danger' align="center"><input type='checkbox' class='is_assessment'
                                                                                 name='privileges[<?=$modul->id?>][is_assessment]'
                                                                                 <?=@$roles->is_assessment ? "checked" : ""?> value='1'/>
                                        </td>
                                        <td class='danger' align="center"><input type='checkbox' class='is_accept'
                                                                                 name='privileges[<?=$modul->id?>][is_accept]'
                                                                                 <?=@$roles->is_accept ? "checked" : ""?> value='1'/>
                                        </td>
                                    @endif
                ...
                <div class="box-footer" align="right">
                    ...
                    <button type='submit' class='btn btn-primary'><i class='fa fa-save'></i> {{cbLang("button_save")}}
                    </button>
                </div><!-- /.box-footer-->
        </div><!-- /.box -->
