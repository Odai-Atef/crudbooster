...
<head>
    <meta charset="UTF-8">
    <title>{{ ($page_title)?get_setting('appname').': '.strip_tags(__($page_title)):"Admin Area" }}</title>
        ...
        <section class="content-header">
            ...
            @if($module)
                <h1>
                    ...
                    <i class='{!! ($page_icon)?:$module->icon !!}'></i> {!! ucwords((__($page_title))?:__($module->name)) !!} &nbsp;&nbsp;
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">{{__($module->name)}}</li>
                </ol>
            @else
